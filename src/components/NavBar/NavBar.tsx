...
const NavBar = () => {
  ...
  const onClickInNavBar = useCallback((value: string) => setClickedInValue(value), []);
  const ref: React.MutableRefObject<HTMLElement | undefined> = useOutsideClick({callback: onClickInNavBar});
  return (
    <div
